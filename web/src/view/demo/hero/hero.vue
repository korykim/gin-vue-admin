  ...
  <el-input v-model="searchInfo.name" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column sortable align="left" label="名字" prop="name" width="120" />

            <el-table-column sortable align="left" label="年龄" prop="age" width="120" />

            <el-table-column align="left" label="能力" prop="power" width="120" />

            <el-table-column align="left" label="起源" prop="origin" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateHeroFunc(scope.row)">编辑</el-button>
...
const getTableData = async() => {
  const table = await getHeroList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
const onDelete = async() => {
  ElMessageBox.confirm('确定要删除吗?', '提示', {
    ...
    type: 'warning'
      ...
      const res = await deleteHeroByIds({ IDs })
      if (res.code === 0) {
        ElMessage({
          type: 'success',
          message: '删除成功'
...
// 更新行
const updateHeroFunc = async(row) => {
    const res = await findHero({ ID: row.ID })
    type.value = 'update'
    if (res.code === 0) {
...
// 删除行
const deleteHeroFunc = async (row) => {
    const res = await deleteHero({ ID: row.ID })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'
