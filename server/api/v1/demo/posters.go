...
// @Param data body demo.Posters true "创建posters表"
...
// @Accept application/json
// @Produce application/json
// @Param data body demo.Posters true "删除posters表"
...
// @Accept application/json
// @Produce application/json
// @Param data body demo.Posters true "更新posters表"
...
// @Success 200 {object} response.Response{data=demo.Posters,msg=string} "查询成功"
